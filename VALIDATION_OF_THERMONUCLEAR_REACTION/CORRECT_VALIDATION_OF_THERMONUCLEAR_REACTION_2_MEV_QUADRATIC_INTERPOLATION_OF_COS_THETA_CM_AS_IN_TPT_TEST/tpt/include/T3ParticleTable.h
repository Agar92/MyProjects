...
//THIS WORKS CORRECTLY:  
  ...
  if(aPDG > nucleusPDGStartAfter)
  {
    if(aPDG == makePDGfromZandA(1,2))      return 1875.6 * MeV;  //m(deuteron)=1875.6127 MeV.
    else if(aPDG == makePDGfromZandA(1,3)) return 2808.9 * MeV;  //m(triton)=2808.9208 MeV.
    else if(aPDG == makePDGfromZandA(2,3)) return 2808.4 * MeV;  //m(3He2)=2808.391 MeV.
    else if(aPDG == makePDGfromZandA(22,48))                     //titan
    {
       int Z=GetZ(aPDG);
       double A=GetA(aPDG);
       return A * aeMass - Z * electronMass - 48.4917 * MeV;
