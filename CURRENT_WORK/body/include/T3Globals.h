...
//-DCMAKE_CXX_STANDARD=17 -DACC=ON -DCUDA=ON
  ...
  const unsigned int GL=1200000;//For i7.
  ...
  constexpr FloatingType TLS=2.0*units::MeV;
  ...
  constexpr unsigned int Nbin = 8;//For GeForce GTX 650 Ti GPU.
